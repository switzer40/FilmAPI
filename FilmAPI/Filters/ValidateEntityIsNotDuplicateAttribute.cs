...
{
    public class ValidateEntityIsNotDuplicateAttribute : TypeFilterAttribute
    {
        public ValidateEntityIsNotDuplicateAttribute() : base(typeof(ValidateEntityIsNotDuplicateFilterImpl))
        {
        }
        private class ValidateEntityIsNotDuplicateFilterImpl : IAsyncActionFilter
        {
            private readonly IFilmRepository _filmRepository;
            private readonly IPersonRepository _personRepository;
            public ValidateEntityIsNotDuplicateFilterImpl(IFilmRepository frepo, IPersonRepository prepo)
            {
            ...
            public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
            {
                if (context.ActionArguments.ContainsKey("t"))
                {
                    ...
                    var arg = context.ActionArguments["t"];
                    try
                    {
